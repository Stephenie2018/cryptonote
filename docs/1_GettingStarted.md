...
To view and edit the project files, you need a code editor. You are free to use any editor you prefer, but we highly recommend **Visual Studio Code (VS Code)** for the best experience.
